...
const app = express();
const port = 3000;
app.use(express.static("public")); // Serve static files from the "public" directory.  Express middleware
...
app.get("/", (req, res) => {
  ...
  //Hint: When the home route is hit, you should send the index.ejs file as a response.
       getCurrentDate();
...
app.post("/submit", (req, res) => {
  ...
  console.log("Random Adjective Index = " + randomAdjIndex );
  console.log("Random Noun Index = " + randomNounIndex + ".");
  const myNoun = noun[randomNounIndex];
  const myAdjective = adj[randomAdjIndex];
  
  console.log("My adjective is: " + myAdjective + ".");
  console.log("My noun  is: " + myNoun + ".");
  let bandName = (myAdjective + " " + myNoun);
  res.render("index.ejs", {bandName : bandName , currentDate : getCurrentDate()  });
